...
def evaluate_all_the_things(array)
  ...
  puts "Sum of all Vitality costs: #{@sum_of_values}"
  ...
  puts "The sum is a #{BigDecimal.new((@sum_of_values / array[0]).to_s).truncate(3).to_f}x
    increase of the initial amount of #{array[0]}"
end
